...
gdjs.Level2Code.GDNext_9595LevelObjects1= [];
gdjs.Level2Code.GDNext_9595LevelObjects2= [];
gdjs.Level2Code.GDNext_9595LevelObjects3= [];
gdjs.Level2Code.GDNext_9595LevelObjects4= [];
...
gdjs.Level2Code.GDFlatHeartBarObjects1= [];
gdjs.Level2Code.GDFlatHeartBarObjects2= [];
gdjs.Level2Code.GDFlatHeartBarObjects3= [];
gdjs.Level2Code.GDFlatHeartBarObjects4= [];
...
gdjs.Level2Code.GDCoin2Objects1= [];
gdjs.Level2Code.GDCoin2Objects2= [];
gdjs.Level2Code.GDCoin2Objects3= [];
gdjs.Level2Code.GDCoin2Objects4= [];
gdjs.Level2Code.GDBacteria3Objects1= [];
gdjs.Level2Code.GDBacteria3Objects2= [];
gdjs.Level2Code.GDBacteria3Objects3= [];
gdjs.Level2Code.GDBacteria3Objects4= [];
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23547188);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23548572);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23550916);
}
}
if (isConditionTrue_0) {
...
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoin2Objects2Objects = Hashtable.newFrom({"Coin2": gdjs.Level2Code.GDCoin2Objects2});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoinParticlesObjects2Objects = Hashtable.newFrom({"CoinParticles": gdjs.Level2Code.GDCoinParticlesObjects2});
gdjs.Level2Code.eventsList7 = function(runtimeScene) {

{

gdjs.copyArray(runtimeScene.getObjects("Coin2"), gdjs.Level2Code.GDCoin2Objects2);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Level2Code.GDPlayerObjects2);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoin2Objects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Coin"), gdjs.Level2Code.GDCoinObjects2);
/* Reuse gdjs.Level2Code.GDCoin2Objects2 */
gdjs.Level2Code.GDCoinParticlesObjects2.length = 0;

{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoinParticlesObjects2Objects, (( gdjs.Level2Code.GDCoinObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDCoinObjects2[0].getCenterXInScene()), (( gdjs.Level2Code.GDCoinObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDCoinObjects2[0].getCenterYInScene()), "");
}{for(var i = 0, len = gdjs.Level2Code.GDCoin2Objects2.length ;i < len;++i) {
    gdjs.Level2Code.GDCoin2Objects2[i].deleteFromScene(runtimeScene);
}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("FlatHeartBar"), gdjs.Level2Code.GDFlatHeartBarObjects1);
...
}{for(var i = 0, len = gdjs.Level2Code.GDFlatHeartBarObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDFlatHeartBarObjects1[i].SetValue(gdjs.Level2Code.GDFlatHeartBarObjects1[i].Value((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) - (1), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
};gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBacteria3Objects2Objects = Hashtable.newFrom({"Bacteria3": gdjs.Level2Code.GDBacteria3Objects2});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects2});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBacteria3Objects2Objects = Hashtable.newFrom({"Bacteria3": gdjs.Level2Code.GDBacteria3Objects2});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBacteria3Objects3Objects = Hashtable.newFrom({"Bacteria3": gdjs.Level2Code.GDBacteria3Objects3});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects3Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects3});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects2});
...
gdjs.Level2Code.GDPlayerObjects3.length = k;
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.Level2Code.GDBacteria3Objects2, gdjs.Level2Code.GDBacteria3Objects3);

/* Reuse gdjs.Level2Code.GDPlayerObjects3 */
{gdjs.evtsExt__Enemy__TriggerFlyDeath.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBacteria3Objects3Objects, "RectangleMovement", "ShakeObject_PositionAngle", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{gdjs.evtsExt__Player__Bounce.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects3Objects, "PlatformerObject", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{runtimeScene.getScene().getVariables().getFromIndex(0).add(50);
}}
...
gdjs.copyArray(runtimeScene.getObjects("Bacteria3"), gdjs.Level2Code.GDBacteria3Objects2);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Level2Code.GDPlayerObjects2);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = !(gdjs.evtsExt__Enemy__IsFlyDead.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBacteria3Objects2Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)));
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBacteria3Objects2Objects, false, runtimeScene, false);
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("BackgroundPlants"), gdjs.Level2Code.GDBackgroundPlantsObjects1);
gdjs.copyArray(runtimeScene.getObjects("Bacteria3"), gdjs.Level2Code.GDBacteria3Objects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDBacteria3Objects1.length;i<l;++i) {
    if ( gdjs.Level2Code.GDBacteria3Objects1[i].getY() > (( gdjs.Level2Code.GDBackgroundPlantsObjects1.length === 0 ) ? 0 :gdjs.Level2Code.GDBackgroundPlantsObjects1[0].getAABBBottom()) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDBacteria3Objects1[k] = gdjs.Level2Code.GDBacteria3Objects1[i];
        ++k;
    }
}
gdjs.Level2Code.GDBacteria3Objects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDBacteria3Objects1 */
{for(var i = 0, len = gdjs.Level2Code.GDBacteria3Objects1.length ;i < len;++i) {
    gdjs.Level2Code.GDBacteria3Objects1[i].deleteFromScene(runtimeScene);
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23586732);
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Next_Level"), gdjs.Level2Code.GDNext_9595LevelObjects2);
...
for(var i = 0, len = gdjs.Level2Code.GDNext_9595LevelObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDNext_9595LevelObjects2[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Next_Level"), gdjs.Level2Code.GDNext_9595LevelObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDNext_9595LevelObjects1.length;i<l;++i) {
    if ( gdjs.Level2Code.GDNext_9595LevelObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDNext_9595LevelObjects1[k] = gdjs.Level2Code.GDNext_9595LevelObjects1[i];
        ++k;
    }
}
gdjs.Level2Code.GDNext_9595LevelObjects1.length = k;
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23584420);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.Level2Code.GDScoreTextObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDScoreTextObjects2[i].getBehavior("Text").setText("Puntaje: " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)));
}
}}
...
gdjs.Level2Code.GDNext_9595LevelObjects1.length = 0;
gdjs.Level2Code.GDNext_9595LevelObjects2.length = 0;
gdjs.Level2Code.GDNext_9595LevelObjects3.length = 0;
gdjs.Level2Code.GDNext_9595LevelObjects4.length = 0;
...
gdjs.Level2Code.GDFlatHeartBarObjects1.length = 0;
gdjs.Level2Code.GDFlatHeartBarObjects2.length = 0;
gdjs.Level2Code.GDFlatHeartBarObjects3.length = 0;
gdjs.Level2Code.GDFlatHeartBarObjects4.length = 0;
...
gdjs.Level2Code.GDCoin2Objects1.length = 0;
gdjs.Level2Code.GDCoin2Objects2.length = 0;
gdjs.Level2Code.GDCoin2Objects3.length = 0;
gdjs.Level2Code.GDCoin2Objects4.length = 0;
gdjs.Level2Code.GDBacteria3Objects1.length = 0;
gdjs.Level2Code.GDBacteria3Objects2.length = 0;
gdjs.Level2Code.GDBacteria3Objects3.length = 0;
gdjs.Level2Code.GDBacteria3Objects4.length = 0;
